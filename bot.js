      ...
      if (!error && response.statusCode === 200) {
        ...
        scraper.search(options, function (err, url) {
          if (err) {
            bot.reply(
              message,
              'There was an error with scraping Google too. Sorry for the inconvinience please try again later.'
            )
          } else {
...
controller.hears('date', 'direct_message,direct_mention,mention', function (
  bot,
  message
) {
...
controller.hears('exit', 'direct_message,direct_mention,mention', function (
  bot,
  message
) {
...
controller.hears('gif (.*)', 'direct_message,direct_mention,mention', function (
  bot,
  message
) {
